...
<div class="page-title">
    ...
    <div class="title_right">
        <div   class="col-md-8 col-sm-8 col-xs-12 form-group pull-right top_search">
            <form method="POST" action="/administracao/palestrante/pesquisar">
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <a href="{{url('administracao/palestrante/cadastrar')}}" class="btn btn-dark"><span class="fa fa-plus"></span> Cadastrar </a>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
